                    ...
                    <div class="properties pb-20">
                        <div class="properties__card">
                            <div class="properties__img overlay1">
                                <a href="#"><img src="<?php echo $formation['img']; ?>" alt=""></a>
                            </div>
                            <div class="properties__caption">
                                <p><?php echo $types['nom']; ?></p>
                                <h3><a href="#"><?php echo $formation['nom']; ?></a></h3>
                                <p><?php echo $formation['ec']; ?>
                                ...
                                <div class="properties__footer d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="price">
                                        <span><?php echo $formation['tmp']; ?>jours</span>
                                    </div>
                                </div>
                ...
                <div class="row">
                     ...
                     <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-topic text-center mb-30">
                            <div class="topic-img">
                                <img src="<?php echo $types['img'];  ?>" alt="">
                                <div class="topic-content-box">
                                    <div class="topic-content">
                                        <h3><a href="blog.php?idt=<?php echo $types['idt']; ?>"><?php echo $types['nom'];  ?></a></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php /*<div class="row">
			...
			?>
                       <div class="col-lg-3 col-md-4 col-sm-6">
                         <div class="single-topic text-center mb-30">
                            <div class="topic-img" >
                                <img src="<?php echo $types['img'];  ?>" xidth="150" alt="">
                                <div class="topic-content-box">
                                    <div class="topic-content">
                                        <h3><a href="#"><?php echo $types['nom']; ?></a></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
